...
// binding values
			...
			preparedStmt.setString(7, dCatergory);
...
// buttons
	...
	public String updateAppointment(String title, String fname, String lname, String phone, String email, String date, String aCatergory, String dCatergory, String dName  )  {
		String output = "";
		try {
			Connection con = connect();
			if (con == null) {
...
// create a prepared statement
			...
			PreparedStatement preparedStmt = con.prepareStatement(query);
// binding values
			preparedStmt.setInt(1, Integer.parseInt(date));
// execute the statement
			preparedStmt.execute();
			con.close();
