...
public class AppointmentAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = appObj.insertAppointment(request.getParameter("title"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = appObj.updateAppointment(paras.get("hidDateSave").toString(),
				...
				paras.get("aCatergory").toString(),
				paras.get("dCatergory").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request);
		String output = appObj.deleteItem(paras.get("date").toString());
		response.getWriter().write(output); 
	}
